      ...
      <div className="right-content w-100 productDetails">
        <div className="card shadow border-0 w-100 flex-row p-4">
          ...
          <Breadcrumbs aria-label="breadcrumb" className="ml-auto breadcrumbs_">
            ...
            <StyledBreadcrumb label="Productos" component="a" href="#" />
            <StyledBreadcrumb label="Vista del Producto" />
          </Breadcrumbs>
        </div>
                ...
                <div className="productInfo mt-4">
                  ...
                  <div className="row">
                    <div className="col-sm-3 d-flex align-items-center">
                      ...
                      <span className="name">Revisión</span>
                    </div>

                    <div className="col-sm-9">
                      : <span>({reviewsData?.length}) Revisión</span>
                    </div>
                  </div>
