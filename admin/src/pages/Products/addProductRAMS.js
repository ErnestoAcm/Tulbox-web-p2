  ...
  const addproductRam = (e) => {
    ...
    if (formFields.productRam === "") {
      context.setAlertBox({
        open: true,
        error: true,
        msg: "Por favor agregue la memoria RAM del producto",
      });
      return false;
    }
  ...
  return (
    <div className="right-content w-100">
      <div className="card shadow border-0 w-100 flex-row p-4 mt-2">
        <h5 className="mb-0">Agregar memoria RAM del producto</h5>
        <Breadcrumbs aria-label="breadcrumb" className="ml-auto breadcrumbs_">
          ...
          <StyledBreadcrumb
            component="a"
            label="Memorias RAM del Producto"
            href="#"
            deleteIcon={<ExpandMoreIcon />}
          />
          <StyledBreadcrumb
            label="Agregar Memorias RAM del Producto"
            deleteIcon={<ExpandMoreIcon />}
          />
        </Breadcrumbs>
      </div>
              ...
              <div className="row">
                <div className="col">
                  <div className="form-group">
                    <h6>MEMORIA RAM DEL PRODUCTO</h6>
                    <input
                      type="text"
                      name="productRam"
              ...
              <div className="table-responsive mt-3">
                <table className="table table-bordered table-striped v-align">
                  <thead className="thead-dark">
                    <tr>
                      <th>MEMORIA RAM DEL PRODUCTO</th>
