      ...
      >
        ...
        <div className="info">
          ...
          {props?.item?.countInStock >= 1 ? (
            <span className="text-success d-block">Disponible</span>
          ) : (
            <span className="text-danger d-block">Agotado</span>
          )}
          ...
          <div className="d-flex">
            <span className="oldPrice">{props?.item?.oldPrice} MXN </span>
            <span className="netPrice text-danger ml-2">
              {props?.item?.price} MXN
            </span>
          </div>
        </div>
      </div>
