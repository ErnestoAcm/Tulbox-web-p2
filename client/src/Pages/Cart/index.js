    ...
    <>
      <section className="section cartPage">
        <div className="container">
          ...
          <p>
            Hay <b className="text-red">{cartData?.length}</b> productos en tu
            carrito
          </p>
          ...
          {cartData?.length !== 0 ? (
                        ...
                        cartData?.map((item, index) => {
                          return (
                            <tr>
                              ...
                              <td width="15%">Mxn. {item?.subTotal}</td>
                              <td width="10%">
                                <span
                                  className="remove"
            ...
            <div className="empty d-flex align-items-center justify-content-center flex-column">
              ...
              <h3>Su carrito está vacío actualmente</h3>
              <br />
              <Link to="/">
                {" "}
